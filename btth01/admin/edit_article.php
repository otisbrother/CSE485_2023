        ...
        <div class="row">
            <div class="col-sm">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArticleTitle">Tiêu đề bài viết</span>
                        <input type="text" class="form-control" name="tieude" value="<?php echo $article['tieude']; ?>">
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArticleContent">Nội dung</span>
                        <textarea class="form-control" name="noidung"><?php echo $article['noidung']; ?></textarea>
                    </div>

                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblArticleImage">Hình ảnh</span>
