...
<body>
    ...
    <main class="container mt-5 mb-5">
        ...
        <div class="row">
            <div class="col-sm">
                <a href="../admin/add_category.php" class="btn btn-success">Thêm mới</a>
                <table class="table">
                    <thead>
                        <tr>
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_category.php?id=<?php echo $row['ma_tloai']; ?>">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a href="?delete_id=<?php echo $row['ma_tloai']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa thể loại này?');">
