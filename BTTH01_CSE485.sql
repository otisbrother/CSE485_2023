...
CREATE TABLE users (
    ...
    role ENUM('user', 'admin') DEFAULT 'user', -- 'admin' cho tài khoản quản trị
...
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (1, "Nhạc trẻ");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (2, "Nhạc trữ tình");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (3, "Nhạc cách mạng");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (4, "Nhạc thiếu nhi");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (5, "Nhạc quê hương");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (6, "POP");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (7, "Rock");
INSERT INTO theloai(ma_tloai, ten_tloai) VALUE (8, "R&B");
